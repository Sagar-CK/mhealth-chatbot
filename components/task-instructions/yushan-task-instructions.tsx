...
export default function YushanTaskInstructions() {
  return (
      <div>
          ...
          <hr />
          <p>
              Imagine you are a bachelor student at risk of expulsion due to not earning enough credits this academic
              year. This situation has become a major source of stress, affecting your mental well-being and making it
              hard to focus on daily tasks, including your studies.
          </p>
          <hr />
