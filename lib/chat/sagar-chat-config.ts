import { type ChatConfig, ResponseType } from "../types"

export const sagarChatConfig : ChatConfig = {
  ...
  steps: [
    ...
    {
      question: "Which activity helps you the most when you're feeling stressed?",
      responseType: ResponseType.Select,
      options: [
        "Exercising",
        "Talking to someone",
